...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, int columns_count, const IndexColumn *attribute_names, const int is_unique);
